  ...
  },
  {
    ...
    icon: (
      <svg aria-hidden="true" width="22" height="22" viewBox="0 0 24 24">
        <text x="12" y="16.5" textAnchor="middle" fill="currentColor" fontSize="13" fontWeight="800" fontStyle="italic" fontFamily="-apple-system,BlinkMacSystemFont,sans-serif">VS</text>
      </svg>
    ),
  },
  {
